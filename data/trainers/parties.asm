...
; ================
	...
	; party
	db 13, PIDGEOTTO NO_ITEM, 16
		db QUICK_ATTACK, GUST, MUD_SLAP, ROOST
	db 12, HOOTHOOT, NO_ITEM, 16
		db TACKLE, HYPNOSIS, CONFUSION, ROOST
	db 14, TOGETIC, LUM_BERRY, 16
		db DISARM_VOICE, SING, ANCIENTPOWER, ROOST
	db -1 ; end
...
; ================
	...
	db 16, SHUCKLE, LEFTOVERS, 32, ABILITY_1 | QUIRKY, FEMALE
		db TOXIC, WRAP, PROTECT, FLASH
	db 18, SCYTHER, SITRUS_BERRY, 32, ABILITY_1 | QUIRKY, FEMALE
		db QUICK_ATTACK, WING_ATTACK, PURSUIT, U_TURN
	db -1 ; end
...
; ================
	...
	db 17, FLAAFFY, NO_ITEM, 36, "Flaaffy@"
